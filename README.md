    ...
    <script>
      function ct() {
        document.getElementById("W").innerHTML =
          "<b>see it changed</b> <br><br><br><br><hr><br> Now click the below button :—) <br> <button onclick='H()'>Click</button><br>";
      }

      function H() {
        document.getElementById("W").innerHTML =
          "<b> SEE IT CHANGED AGAIN <br> click the below button again and try to restart :-) </b>";
      }
    </script>
  </body>
</html>
